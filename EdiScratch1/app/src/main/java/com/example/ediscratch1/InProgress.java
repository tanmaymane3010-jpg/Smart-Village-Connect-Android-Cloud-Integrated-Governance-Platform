...
public class InProgress extends AppCompatActivity {
    ...
    private FirestoreRecyclerAdapter adapter_progress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query1 = firebaseFirestore.collection("user_complaints").whereEqualTo("Resolved_Status","scrutinized");

        FirestoreRecyclerOptions<ProductsModel> options1 = new FirestoreRecyclerOptions.Builder<ProductsModel>()
                .setQuery(query1,ProductsModel.class).build();

        adapter_progress = new FirestoreRecyclerAdapter<ProductsModel, ProductModelViewHolder>(options1) {
            @NonNull
            @Override
            public ProductModelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.complaint_in_progress_card,parent,false);
                return new ProductModelViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull ProductModelViewHolder holder, int position, @NonNull ProductsModel model) {
                ...
                holder.imageBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        int result = ContextCompat.checkSelfPermission(InProgress.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);
        ...
        recyclerView2.setAdapter(adapter_progress);
    }

    private void requestPermission() {
        ActivityCompat.requestPermissions(InProgress.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
    }
    ...
    private class ProductModelViewHolder extends RecyclerView.ViewHolder{
        ...
        public ProductModelViewHolder(@NonNull View itemView) {
            ...
            address = itemView.findViewById(R.id.txt_location1);
            date_and_time = itemView.findViewById(R.id.txt_date_time1);
            description = itemView.findViewById(R.id.Complainant_description1);
            ...
            imageView = itemView.findViewById(R.id.complaints_image_imageview1);
            imageBtn = itemView.findViewById(R.id.video_download_btn1);
            working = itemView.findViewById(R.id.btn_inprocess1);
            complete = itemView.findViewById(R.id.btn_complete1);
    ...
    protected void onStart() {
        super.onStart();
        adapter_progress.startListening();
    }

    @Override
    protected void onStop() {
        super.onStop();
        adapter_progress.stopListening();
    }
}