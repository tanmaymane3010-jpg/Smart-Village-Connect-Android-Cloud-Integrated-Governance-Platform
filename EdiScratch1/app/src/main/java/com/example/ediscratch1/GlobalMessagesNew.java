...
public class GlobalMessagesNew extends AppCompatActivity {

    EditText globalTitle, globalDesc;
    ImageView globalImageView;
    ImageButton addImageGlobal,sendGlobalMsg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_global_messages_new);

        globalTitle = findViewById(R.id.Admin_Global_Title);
        globalDesc = findViewById(R.id.Admin_Global_Description);
        globalImageView = findViewById(R.id.global_message_image_imageview);
        addImageGlobal = findViewById(R.id.Admin_Global_addImg);
        sendGlobalMsg = findViewById(R.id.Admin_Global_Msg_send);
        ...
        documentReference = db.collection("admin_global_messages").document();
            ...
            Task<Uri> urlTask2 = uploadTask1.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        globalMsgs.put("Id",documentReference.getId());
                        ...
                        documentReference.set(globalMsgs).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                ...
                                pd.dismiss();
                                Toast.makeText(GlobalMessagesNew.this, "Occasional Message Sent Successfully", Toast.LENGTH_SHORT).show();
                                ...
                                Intent intent = new Intent(GlobalMessagesNew.this,AdminGlobalMessages.class);
